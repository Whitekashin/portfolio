/* export const Work = [
  {
    id: 1,
    name: "Webshop",
    description: "Built on top of React js and with use of styledComponents",
    tags: [
      "react",
      "commercejs",
      "styledComponents",
  ...
  },
  {
    ...
    description:
      "Built using the React library in conclusion with the Clarifai api, using a Server and Database for Login functionality",
  ...
  },
  {
    ...
    description:
      "A simple, yet fancy landing page making use of styledComponents",
  ...
  },
  {
    ...
    description: "Built using React, Gatsby and Graphql",
  ...
  },
  {
    ...
    description:
      "Made as the final project during my Javascript course. A recipe finder making use of Javascript and an API",
    tags: ["js", "css", "api"],
